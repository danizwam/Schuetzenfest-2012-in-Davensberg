...
public class ZweiteSeite extends ParentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ZweiteSeite.this, "Zweite Seite: " + DANIEL, 10000).show();
    ...
    public void mittwochButtonMaps(View v){
    	Toast.makeText(ZweiteSeite.this, R.string.mittwochMapsLoadingText, 2000).show();
    	TextView t = new TextView(ZweiteSeite.this);
    	t.setText(R.string.haverkampGeo);
    	Toast.makeText(ZweiteSeite.this, t.getText(), 2000).show();
